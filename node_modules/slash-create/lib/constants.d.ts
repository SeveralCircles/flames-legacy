...
declare type ApplicationCommandOptionBase = {
...
export interface ApplicationCommandOptionNotSubCommand {
    /** The type of option this one is. */
    type: CommandOptionType.STRING | CommandOptionType.INTEGER | CommandOptionType.BOOLEAN | CommandOptionType.USER | CommandOptionType.CHANNEL | CommandOptionType.ROLE;
    options?: never;
}
/** An option in an application command. */
export declare type ApplicationCommandOption = ApplicationCommandOptionBase & (ApplicationCommandOptionSubCommand | ApplicationCommandOptionNotSubCommand);
...
/** Any component. */
export declare type AnyComponent = ComponentActionRow | AnyComponentButton;
/** A row of components. */
